...
[ ] proposed, [X] accepted, [ ] rejected, [ ] deprecated, [X] superseded by [ADR004.md](ADR004.md)
...
Wraparound Sync atomic is False Sharing prone, because multiple Readers will be updating it concurrently. This can lead to performance degradation. Addressed by [ADR0004.md](ADR0004.md).
